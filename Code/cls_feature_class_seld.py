...
class FeatureClass:
    def __init__(self, dataset='ansim', ov=3, split=1, nfft=1024, db=30, wav_extra_name='', desc_extra_name='', is_eval=False):
        """
        ...
        self._hop_len = int(self._nfft/2)
        ...
        self._audio_max_len_samples = 30 * self._fs  # TODO: Fix the audio synthesis code to always generate 60s of
    ...
    def extract_all_labels(self, mode, weakness):
        self._label_dir = self.get_label_dir(mode, weakness)
