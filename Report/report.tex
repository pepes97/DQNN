...
\begin{document}
    ...
    \paragraph{}
    We wrote a Python script in order to divide the dataset in the right way. The script automatically
    \paragraph{}
    The dataset results to be divided in 4 directories: the main division is about the number of overlaps,  
    \section{Metrics}
    \paragraph{}
    ...
    \paragraph{}
    We did experiments using two different approaches.
...
In the Seld Network we used the default parameters of 

    \section{Results}
    tabelle e intervalli di confidenza.
    \section{Conclusion}
