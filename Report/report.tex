...
\begin{document}
	...
	\end{figure}
	%\FloatBarrier
	\\ \\ \\ We can see what we have achieved with both the two overlaps (ov1 and ov2). The red line refers to the 32 filter network with 2 overlaps (ov2), while the light blue line refers to the 32 filter network with a single sound overlap. Indeed, what can be seen from the graphs above is that the network with 32 filters with a single overlap is better than that with two overlaps. This is because the second overlap makes the sound less clear and more difficult to locate and reveal.
	...
	\begin{table}[h!]
		...
		\begin{tabular}{c|c}
			...
			\end{tabular}
		\end{tabular}
		\caption{The best results of the TAT Dataset in terms of the SED score, DOA score and SELD score considering neural network with 32 filters. In the case of ov1 we obtained the best values in epoch 156, instead for ov2 in epoch 133.}
	\end{table}
	...
	\begin{table}[h!]
		...
		\begin{tabular}{c|c|c|c}
			...
			\end{tabular} \\
		\end{tabular}
		\caption{The best results of the TAT Dataset in terms of the SED score, DOA score and SELD score considering several experiments. In the case of ov1 we obtained the best values for 16 filter in epoch 145 and for CNN in epoch 142. Indeed in ov2 we obtained the best values for 16 filter in epoch 114 and for CNN in epoch 141.}
	\end{table}	
    \section{Conclusion}
