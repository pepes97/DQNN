...
\begin{document}
    ...
    \begin{figure}[htb!]
        \centering
        \fbox{\includegraphics[width=0.5\linewidth]{QRCNN}}
	...
	\begin{minipage}{0.5\textwidth}
	  \centering
	  \includegraphics[width=\linewidth]{images/doa_score.png}
	...
	\begin{table}[h!]
		...
		\begin{tabular}{c|c|c|c}
			...
			\end{tabular} \\
		\end{tabular}
		\caption{The best results of the TAT Dataset in terms of the SED score, DOA score and SELD score considering several experiments.}
	\end{table}	
    \section{Conclusion}
