...
for ovo in [1, 2]:
  ...
  for splito in [1,2,3,4]:
    ...
    for f in file_list:
      if ov in f and split in f and "." in f:
        print(f)
...
for folder in folders:
  ...
  for i, f in enumerate(lista):
    ...
    if folder=="ov1":
      ...
      for x in a:
        shutil.copyfile(os.path.join(folder,f"test_{i}_desc_30_100.wav"), "../../../../../foa_dev/"+x+"/"+f"test_{i}_desc_30_100.wav")
    else:
      fol = os.listdir("../../../../../foa_dev/")
      a = []
      for x in fol:
...
for folder in folders:
  ...
  for i, f in enumerate(lista):
    ...
    if folder == "ov1":
      ...
      for x in a:
        shutil.copyfile(os.path.join(folder,f"test_{i}_desc_30_100.csv"), "../foa_dev/"+x+"/"+f"test_{i}_desc_30_100.csv")
